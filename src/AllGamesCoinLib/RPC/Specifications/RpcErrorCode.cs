...
namespace AllGamesCoinLib.RPC.Specifications
{
    //  As of: https://github.com/allgamescoindev/allgamescoin/blob/master/src/rpcprotocol.h 
    ...
    public enum RpcErrorCode
    {
        ...
        //! P2P client errors
        RPC_CLIENT_NOT_CONNECTED = -9, //! AllGamesCoin is not connected
