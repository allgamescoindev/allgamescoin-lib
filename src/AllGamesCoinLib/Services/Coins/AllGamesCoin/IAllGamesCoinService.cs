...
{
    public interface IAllGamesCoinService : ICoinService, IAllGamesCoinConstants
    {
        /// <summary>
        ///     Send an amount to a given address.
        /// </summary>
        /// <param name="allgamescoinAddress">The allgamescoin address to send to.</param>
        /// <param name="amount">The amount in AllGamesCoin to send. eg 0.1.</param>
        /// <param name="comment">
        ...
        ///     less amount of AllGamesCoin than you enter in the amount field.
        /// </param>
        ...
        string SendToAddress(string allgamescoinAddress, decimal amount, string comment = null,
