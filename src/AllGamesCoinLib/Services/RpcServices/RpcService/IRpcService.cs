...
namespace AllGamesCoinLib.Services.RpcServices.RpcService
{
    public interface IRpcService
    {
        ...
        ValidateAddressResponse ValidateAddress(string allgamescoinAddress);
        bool VerifyMessage(string allgamescoinAddress, string signature, string message);
        ...
        string DumpPrivKey(string allgamescoinAddress);
        void DumpWallet(string filename);
        string GetAccount(string allgamescoinAddress);
        ...
        decimal GetReceivedByAddress(string allgamescoinAddress, int minConf = 1);
        ...
        string SendFrom(string fromAccount, string toallgamescoinAddress, decimal amount, int minConf = 1, string comment = null, string commentTo = null);
        string SendMany(string fromAccount, Dictionary<string, decimal> toallgamescoinAddress, int minConf = 1, string comment = null);
        string SendToAddress(string allgamescoinAddress, decimal amount, string comment = null, string commentTo = null, bool subtractFeeFromAmount = false);
        string SetAccount(string allgamescoinAddress, string account);
        string SetTxFee(decimal amount);
        string SignMessage(string allgamescoinAddress, string message);
        string WalletLock();
