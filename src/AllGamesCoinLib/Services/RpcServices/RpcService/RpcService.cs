...
using System.Linq;
using AllGamesCoinLib.Requests.AddNode;
using AllGamesCoinLib.Requests.CreateRawTransaction;
using AllGamesCoinLib.Requests.SignRawTransaction;
using AllGamesCoinLib.Responses;
using AllGamesCoinLib.RPC.Connector;
using AllGamesCoinLib.RPC.Specifications;
using AllGamesCoinLib.Services.Coins.Base;
using Newtonsoft.Json.Linq;

namespace AllGamesCoinLib.Services
{
    ...
    public partial class CoinService : ICoinService
    {
        ...
        public string DumpPrivKey(string allgamescoinAddress)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.dumpprivkey, allgamescoinAddress);
        }
        ...
        public string GetAccount(string allgamescoinAddress)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.getaccount, allgamescoinAddress);
        }
        ...
        public decimal GetReceivedByAddress(string allgamescoinAddress, int minConf)
        {
            return _rpcConnector.MakeRequest<decimal>(RpcMethods.getreceivedbyaddress, allgamescoinAddress, minConf);
        }
        ...
        public string SendFrom(string fromAccount, string toallgamescoinAddress, decimal amount, int minConf, string comment, string commentTo)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.sendfrom, fromAccount, toallgamescoinAddress, amount, minConf, comment, commentTo);
        }

        public string SendMany(string fromAccount, Dictionary<string, decimal> toallgamescoinAddress, int minConf, string comment)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.sendmany, fromAccount, toallgamescoinAddress, minConf, comment);
        }
        ...
        public string SendToAddress(string allgamescoinAddress, decimal amount, string comment, string commentTo, bool subtractFeeFromAmount)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.sendtoaddress, allgamescoinAddress, amount, comment, commentTo, subtractFeeFromAmount);
        }

        public string SetAccount(string allgamescoinAddress, string account)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.setaccount, allgamescoinAddress, account);
        }
        ...
        public string SignMessage(string allgamescoinAddress, string message)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.signmessage, allgamescoinAddress, message);
        }
        ...
        public ValidateAddressResponse ValidateAddress(string allgamescoinAddress)
        {
            return _rpcConnector.MakeRequest<ValidateAddressResponse>(RpcMethods.validateaddress, allgamescoinAddress);
        }
        ...
        public bool VerifyMessage(string allgamescoinAddress, string signature, string message)
        {
            return _rpcConnector.MakeRequest<bool>(RpcMethods.verifymessage, allgamescoinAddress, signature, message);
        }
